  ...
  return (
    <footer className="bg-neutral-900 text-neutral-300 relative">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-10 py-16 md:py-24 md:grid-cols-2 md:justify-items-center md:items-center text-center">
          {/* Brand */}
      ...
      {/* Desktop-only mirrored logos - absolutely positioned so they don't affect layout */}
