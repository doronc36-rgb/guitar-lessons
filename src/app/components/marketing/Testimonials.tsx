  ...
  return (
    <Container className="py-4">
      <Section id="testimonials" title={t.marketing.testimonials.title} intro={t.marketing.testimonials.subtitle}>
        <div className="p-3 rounded-md shadow-sm border-l-4 border-blue-500 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border border-gray-100 dark:border-gray-700 text-center">
