    ...
    <div className="min-h-screen">
      ...
      <Container className="mt-12">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <Section title={t.home.whatYouGet.title} intro={t.marketing.features.subtitle} className="border-l-4 border-indigo-500 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20">
            <ul className="list-disc pr-6 mt-1 text-[color:var(--foreground)] space-y-1">
          ...
          <Section title={t.home.howItWorks.title} className="border-l-4 border-sky-500 bg-gradient-to-br from-sky-50 to-sky-100 dark:from-sky-900/20 dark:to-sky-800/20">
