  ...
  return (
    <Container>
      <Section id="testimonials" title={t.marketing.testimonials.title} intro={t.marketing.testimonials.subtitle}>
        <div className="p-6 rounded-md shadow-sm border-l-4 border-teal-500 bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-900/20 dark:to-teal-800/20 border border-gray-100 dark:border-gray-700">
